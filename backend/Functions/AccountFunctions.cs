...
namespace FinanceApp.Functions
{
    public class AccountFunctions
    {
        ...
        public async Task<IActionResult> UpdateAccount(
            [HttpTrigger(AuthorizationLevel.Anonymous, "put", Route = "accounts/{id}")] HttpRequest req,
            string id)
        {
            string userId = "mock-user-123";
            var requestBody = await new StreamReader(req.Body).ReadToEndAsync();
        ...
        public async Task<IActionResult> DeleteAccount(
            [HttpTrigger(AuthorizationLevel.Anonymous, "delete", Route = "accounts/{id}")] HttpRequest req,
            string id)
        {
            string userId = "mock-user-123";
        ...
        public async Task<IActionResult> GetAccountGroups(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "account-groups")] HttpRequest req)
        {
            string userId = "mock-user-123";
        ...
        public async Task<IActionResult> CreateAccountGroup(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "account-groups")] HttpRequest req)
        {
            string userId = "mock-user-123";
            var requestBody = await new StreamReader(req.Body).ReadToEndAsync();
        ...
        public async Task<IActionResult> DeleteAccountGroup(
            [HttpTrigger(AuthorizationLevel.Anonymous, "delete", Route = "account-groups/{id}")] HttpRequest req,
            string id)
        {
            string userId = "mock-user-123";
